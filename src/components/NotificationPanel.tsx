...
export function NotificationPanel({ onClose }: NotificationPanelProps) {
  ...
  useEffect(() => {
    ...
    // Delay attaching to avoid the triggering click
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-brand-800">
        ...
        <button
          onClick={() => markAllRead()}
          className="text-[10px] font-bold uppercase tracking-widest text-brand-500 hover:text-brand-200 transition-colors"
        >
        ...
        {notifications.length === 0 ? (
          ...
          notifications.map((notification) => (
            <button
              ...
              className={`w-full text-left flex items-start gap-3 px-4 py-3 border-b border-brand-800/50 transition-colors hover:bg-brand-800/50 ${
