  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-black/40 backdrop-blur-sm border border-white/10 text-xs font-bold uppercase tracking-widest transition-colors hover:bg-black/60 text-white/70 hover:text-white"
      >
